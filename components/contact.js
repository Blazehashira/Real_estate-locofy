        ...
        <div className="self-stretch shadow-[0px_0px_24px_rgba(0,_0,_0,_0.03)] rounded-xl bg-gray-white flex flex-col items-center justify-start py-7 px-[30px] gap-[17px] text-left text-5xl text-darkslategray font-poppins">
          ...
          <div className="self-stretch flex flex-col items-center justify-start gap-[10px]">
            ...
            <textarea
              ...
              required={true}
            />
            <button className="cursor-pointer [border:none] p-0 bg-primary-500 w-[222px] rounded h-[46px] flex flex-col items-center justify-center hover:bg-royalblue lg:bg-blueviolet sm:self-stretch sm:w-auto sm:max-w-full">
