...
const RentPropertyForm = ({ className = "" }) => {
  return (
    <div
    ...
    >
      <div className="self-stretch flex flex-col items-center justify-start gap-[40px] max-w-[95%]">
        ...
        <div className="self-stretch flex flex-row flex-wrap items-start justify-center gap-[146.7px] text-left text-base text-gray-white">
          <PropertyRentCard />
